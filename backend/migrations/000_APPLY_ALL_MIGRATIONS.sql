...
-- ============================================================================
-- MIGRATION 011: current_question_index for survey_progress
-- ============================================================================

-- Add column to track progress derived from answers
...
-- Trigger function to keep current_question_index in sync
...
-- Trigger to update before insert/update
